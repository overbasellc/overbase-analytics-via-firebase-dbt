...
SELECT    TIMESTAMP_MICROS(event_timestamp) as created_at
         , {{ generate_date_timezone_tuple('TIMESTAMP_MICROS(event_timestamp)') }} as created_dates
        , TIMESTAMP_MICROS(user_first_touch_timestamp) as installed_at
         , {{ generate_date_timezone_tuple('TIMESTAMP_MICROS(user_first_touch_timestamp)') }} as installed_dates
        , user_pseudo_id
        , user_id
